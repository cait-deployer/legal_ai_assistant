...
const SETTINGS_SCHEMA: Record<string, { type: "text" | "float" | "int" | "bool"; default: string | number | boolean; secret?: boolean }> = {
  ...
  title_boost_max_pages: { type: "int", default: 2 },
  title_boost_max_docs_per_collection: { type: "int", default: 12 },
  doc_expansion_max_docs: { type: "int", default: 4 },
  doc_expansion_chunks_per_doc: { type: "int", default: 2 },
