...
async def _ask_pipeline(body: AskRequest) -> dict:
    ...
    try:
        ...
        response_instructions.append(
            "ПРАВИЛО СФЕРИ ДІЇ НОРМИ (обов'язкове): не поширюй норму на іншу категорію осіб, "
            "підприємств або правовідносин, якщо це прямо не випливає з процитованого документа. "
            "Якщо документ регулює лише окрему категорію (наприклад, бюджетні установи, держслужбовців, "
            "резидентів/нерезидентів, працівників певного органу), прямо назви цю межу і не роби висновок "
            "«так само для всіх». Для іншої категорії дай окремий висновок лише за наявності прямого джерела; "
            "інакше напиши, що в наданому контексті прямої норми для цієї категорії немає."
        )
